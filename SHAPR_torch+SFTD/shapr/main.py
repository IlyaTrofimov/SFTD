    ...
    if args is not None and args.fold is not None:
        ...
        for fold, train_index, test_index in folds:
            run_fold(
                ...
                filenames=filenames,
                settings=settings,
                project='SHAPR_topological_cell',
                entity='shapr_topological_cell',
                gpus=gpus,
            )
...
def run_fold(
    ...
    print('wandb init, project:', project)
